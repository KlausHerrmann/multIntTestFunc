...
\addcontentsline{toc}{subsection}{C.4\hspace{0.5cm}Bratley-Fox-Niederreiter $I_1$}
For the function
\begin{align*}
...
\addcontentsline{toc}{subsection}{C.5\hspace{0.5cm}Bratley-Fox-Niederreiter $I_2$}
For the function
\begin{align*}
...
\addcontentsline{toc}{subsection}{C.6\hspace{0.5cm}Bratley-Fox-Niederreiter $I_3$}
For the function
\begin{align*}
...
\addcontentsline{toc}{subsection}{C.7\hspace{0.5cm}Bratley-Fox-Niederreiter $I_4$}
For the function
\begin{align*}
...
\addcontentsline{toc}{subsection}{C.8\hspace{0.5cm}Genz Oscillatory $f_1$}
